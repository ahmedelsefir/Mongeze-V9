...
# --- 🚀 5. بوابة فتح البرامج الجديدة (التصحيح النهائي) ---
st.divider()
with st.expander("➕ إضافة موديول جديد للسيستم"):
    st.write("يمكنك طلب إضافة برنامج (مخازن، شحن دولي) وسيقوم الذكاء بتوليده.")
    new_app_idea = st.text_input("اسم البرنامج الجديد:")
    
    # تصحيح السطر 132
    if st.button("توليد هيكل البرنامج"):
        st.write(f"جاري تحضير موديول {new_app_idea} في بيئة العمل السحابية...")
        st.balloons()
