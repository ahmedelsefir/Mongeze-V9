...
with col2:
    ...
    st.markdown('<div class="subtitle">نسخة العميل - اطلب الآن</div>', unsafe_allow_html=True)
...
if submit_button:
    ...
    # عرض رقم الطلب الفريد
    st.markdown("### 📄 ملخص طلبك:")
    st.markdown(f"## 🎫 رقم طلبك: **{order_id}**")
    st.markdown("*احفظ هذا الرقم - سيستخدمه المناديل والمطعم*")
